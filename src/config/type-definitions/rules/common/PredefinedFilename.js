 ...
 * @property {string} path used to tie files from specific locations to specific restrictions. End path with `asterisk` (e.g. `src/helpers/*`) to allow for any number of nestings after specified `path`.
