...
const {
    common: { LoopLengthConditionInitializationRule }
} = require('src/rules');
...
describe('invoke function', () => {
    ...
    it('returns empty array on valid for loop condition statement', () => {
        const loopLengthConditionInitializationRule =
            new LoopLengthConditionInitializationRule(
                pepegaContext,
                {},
                {
                    ...file,
        ...
        const result = loopLengthConditionInitializationRule.invoke();
